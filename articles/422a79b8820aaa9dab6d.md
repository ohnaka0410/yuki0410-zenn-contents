...
# 実装
## ベース
サクッとTS環境を構築したかったので、[@vue/cli](https://www.npmjs.com/package/@vue/cli)を利用した。
...
### アダプタ
実際は[axios](https://www.npmjs.com/package/axios)などを使ってAPIを叩いたり、FireBaseのFireStorageへの保存処理を行う想定です。
